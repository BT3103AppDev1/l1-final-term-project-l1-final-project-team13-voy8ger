  ...
  <div class="page-header min-vh-90" loading="lazy">
    <v-container>
        <v-row align="center" class="mt-15" justify="center">
            <v-card title="My Favourites" class="text-center">
            </v-card>
        </v-row>
        

        <v-row justify="center" class="mt-5"> <!-- Centering horizontally with space above -->
            <v-col cols="12" sm="6" md="4"> <!-- Adjust the column size as needed -->
            <v-text-field
            v-model="search"
        ...
        <v-row>
        <v-col v-for="output in temp" cols="4"> <!-- :key="card.id" -->
